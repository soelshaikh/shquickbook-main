interface VendorPaymentListHeaderProps {
  selectedCount: number;
  totalCount: number;
}

export function VendorPaymentListHeader({ selectedCount, totalCount }: VendorPaymentListHeaderProps) {
  return (
    <div className="h-8 flex items-center px-3 text-xs font-medium text-muted-foreground border-b border-border bg-muted/30">
      {selectedCount > 0 ? (
        ...
        <>
          ...
          <div className="flex-1 min-w-0">Vendor</div>
