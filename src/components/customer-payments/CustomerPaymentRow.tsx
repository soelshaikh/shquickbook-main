...
export const CustomerPaymentRow = memo(({ payment, isSelected, isFocused, isMultiSelected, style, onClick, onDoubleClick }: CustomerPaymentRowProps) => {
...
CustomerPaymentRow.displayName = 'CustomerPaymentRow';
